-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable22
-- Source Path: robot_fis/MinMax Running Resettable22
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable22 IS
...
END MinMax_Running_Resettable22;


ARCHITECTURE rtl OF MinMax_Running_Resettable22 IS

  -- Component Declarations
  COMPONENT Subsystem_block13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block13
    USE ENTITY work.Subsystem_block13(rtl);
