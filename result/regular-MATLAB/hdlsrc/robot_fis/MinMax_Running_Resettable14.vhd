-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable14
-- Source Path: robot_fis/MinMax Running Resettable14
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable14 IS
...
END MinMax_Running_Resettable14;


ARCHITECTURE rtl OF MinMax_Running_Resettable14 IS

  -- Component Declarations
  COMPONENT Subsystem_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block5
    USE ENTITY work.Subsystem_block5(rtl);
