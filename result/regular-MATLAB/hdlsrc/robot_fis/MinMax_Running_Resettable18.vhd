-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable18
-- Source Path: robot_fis/MinMax Running Resettable18
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable18 IS
...
END MinMax_Running_Resettable18;


ARCHITECTURE rtl OF MinMax_Running_Resettable18 IS

  -- Component Declarations
  COMPONENT Subsystem_block9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block9
    USE ENTITY work.Subsystem_block9(rtl);
