-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable4
-- Source Path: robot_fis/MinMax Running Resettable4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable4 IS
...
END MinMax_Running_Resettable4;


ARCHITECTURE rtl OF MinMax_Running_Resettable4 IS

  -- Component Declarations
  COMPONENT Subsystem_block18
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block18
    USE ENTITY work.Subsystem_block18(rtl);
