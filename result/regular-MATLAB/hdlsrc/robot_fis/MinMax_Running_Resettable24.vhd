-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable24
-- Source Path: robot_fis/MinMax Running Resettable24
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable24 IS
...
END MinMax_Running_Resettable24;


ARCHITECTURE rtl OF MinMax_Running_Resettable24 IS

  -- Component Declarations
  COMPONENT Subsystem_block15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block15
    USE ENTITY work.Subsystem_block15(rtl);
