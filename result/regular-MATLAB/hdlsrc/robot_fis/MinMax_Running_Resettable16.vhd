-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable16
-- Source Path: robot_fis/MinMax Running Resettable16
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable16 IS
...
END MinMax_Running_Resettable16;


ARCHITECTURE rtl OF MinMax_Running_Resettable16 IS

  -- Component Declarations
  COMPONENT Subsystem_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block7
    USE ENTITY work.Subsystem_block7(rtl);
