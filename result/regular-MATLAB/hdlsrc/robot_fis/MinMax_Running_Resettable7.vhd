-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable7
-- Source Path: robot_fis/MinMax Running Resettable7
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable7 IS
...
END MinMax_Running_Resettable7;


ARCHITECTURE rtl OF MinMax_Running_Resettable7 IS

  -- Component Declarations
  COMPONENT Subsystem_block21
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block21
    USE ENTITY work.Subsystem_block21(rtl);
