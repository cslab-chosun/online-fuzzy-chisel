-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable3
-- Source Path: robot_fis/MinMax Running Resettable3
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable3 IS
...
END MinMax_Running_Resettable3;


ARCHITECTURE rtl OF MinMax_Running_Resettable3 IS

  -- Component Declarations
  COMPONENT Subsystem_block17
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block17
    USE ENTITY work.Subsystem_block17(rtl);
