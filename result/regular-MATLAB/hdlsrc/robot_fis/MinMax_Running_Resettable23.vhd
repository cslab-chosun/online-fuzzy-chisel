-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable23
-- Source Path: robot_fis/MinMax Running Resettable23
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable23 IS
...
END MinMax_Running_Resettable23;


ARCHITECTURE rtl OF MinMax_Running_Resettable23 IS

  -- Component Declarations
  COMPONENT Subsystem_block14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block14
    USE ENTITY work.Subsystem_block14(rtl);
