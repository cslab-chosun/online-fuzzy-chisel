-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable9
-- Source Path: robot_fis/MinMax Running Resettable9
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable9 IS
...
END MinMax_Running_Resettable9;


ARCHITECTURE rtl OF MinMax_Running_Resettable9 IS

  -- Component Declarations
  COMPONENT Subsystem_block23
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block23
    USE ENTITY work.Subsystem_block23(rtl);
