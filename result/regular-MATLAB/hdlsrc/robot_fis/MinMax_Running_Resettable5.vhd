-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable5
-- Source Path: robot_fis/MinMax Running Resettable5
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable5 IS
...
END MinMax_Running_Resettable5;


ARCHITECTURE rtl OF MinMax_Running_Resettable5 IS

  -- Component Declarations
  COMPONENT Subsystem_block19
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block19
    USE ENTITY work.Subsystem_block19(rtl);
