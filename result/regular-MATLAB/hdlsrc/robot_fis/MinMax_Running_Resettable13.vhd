-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable13
-- Source Path: robot_fis/MinMax Running Resettable13
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable13 IS
...
END MinMax_Running_Resettable13;


ARCHITECTURE rtl OF MinMax_Running_Resettable13 IS

  -- Component Declarations
  COMPONENT Subsystem_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block4
    USE ENTITY work.Subsystem_block4(rtl);
