-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable25.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable25
-- Source Path: robot_fis/MinMax Running Resettable25
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable25 IS
...
END MinMax_Running_Resettable25;


ARCHITECTURE rtl OF MinMax_Running_Resettable25 IS

  -- Component Declarations
  COMPONENT Subsystem_block16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block16
    USE ENTITY work.Subsystem_block16(rtl);
