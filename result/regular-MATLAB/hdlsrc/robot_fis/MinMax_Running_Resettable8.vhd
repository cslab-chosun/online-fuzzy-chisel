-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable8
-- Source Path: robot_fis/MinMax Running Resettable8
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable8 IS
...
END MinMax_Running_Resettable8;


ARCHITECTURE rtl OF MinMax_Running_Resettable8 IS

  -- Component Declarations
  COMPONENT Subsystem_block22
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block22
    USE ENTITY work.Subsystem_block22(rtl);
