-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable20
-- Source Path: robot_fis/MinMax Running Resettable20
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable20 IS
...
END MinMax_Running_Resettable20;


ARCHITECTURE rtl OF MinMax_Running_Resettable20 IS

  -- Component Declarations
  COMPONENT Subsystem_block11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block11
    USE ENTITY work.Subsystem_block11(rtl);
