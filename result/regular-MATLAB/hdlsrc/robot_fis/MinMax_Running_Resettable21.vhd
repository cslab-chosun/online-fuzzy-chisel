-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable21.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable21
-- Source Path: robot_fis/MinMax Running Resettable21
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable21 IS
...
END MinMax_Running_Resettable21;


ARCHITECTURE rtl OF MinMax_Running_Resettable21 IS

  -- Component Declarations
  COMPONENT Subsystem_block12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block12
    USE ENTITY work.Subsystem_block12(rtl);
