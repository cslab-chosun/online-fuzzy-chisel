-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable6
-- Source Path: robot_fis/MinMax Running Resettable6
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable6 IS
...
END MinMax_Running_Resettable6;


ARCHITECTURE rtl OF MinMax_Running_Resettable6 IS

  -- Component Declarations
  COMPONENT Subsystem_block20
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block20
    USE ENTITY work.Subsystem_block20(rtl);
