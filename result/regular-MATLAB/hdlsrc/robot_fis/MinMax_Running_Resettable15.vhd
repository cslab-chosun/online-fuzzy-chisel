-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\robot_fis\MinMax_Running_Resettable15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MinMax_Running_Resettable15
-- Source Path: robot_fis/MinMax Running Resettable15
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MinMax_Running_Resettable15 IS
...
END MinMax_Running_Resettable15;


ARCHITECTURE rtl OF MinMax_Running_Resettable15 IS

  -- Component Declarations
  COMPONENT Subsystem_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Subsystem_block6
    USE ENTITY work.Subsystem_block6(rtl);
